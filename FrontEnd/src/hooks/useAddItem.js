...
export default function useAddItem(onSuccess) {
  ...
  const open  = () => { setForm(INITIAL_FORM); setError(""); setIsOpen(true); };
  ...
  return { isOpen, open, close, form, handleChange, categories, handleSubmit, isSubmitting, error };
}